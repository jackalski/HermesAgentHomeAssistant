...
<body>
  <div class="card">
    ...
    <details>
      ...
      <div class="muted" style="margin-top:6px">
        The add-on starts the gateway automatically. For manual debugging in the terminal use <code>hermes gateway run</code> (not <code>hermes-agent gateway run</code>). Default Hermes Agent is <b>0.17.0</b>; set <code>hermes_agent_version_preset</code> to <b>latest</b> to track upstream npm.
      </div>
    </details>
